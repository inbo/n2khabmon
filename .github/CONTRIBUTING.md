# Contributing to n2khabmon

First of all, thanks for considering contributing to n2khabmon! 👍 It's people like you that make it rewarding for us - the project maintainers - to work on n2khabmon. 😊

n2khabmon is an open source project, maintained by people who care. We are not directly funded to do so.

[repo]: https://github.com/inbo/n2khabmon
[issues]: https://github.com/inbo/n2khabmon/issues
[new_issue]: https://github.com/inbo/n2khabmon/issues/new
[website]: https://inbo.github.io/n2khabmon
[citation]: https://inbo.github.io/n2khabmon/authors.html
...
Using n2khabmon for a paper you are writing? Consider [citing it][citation].
...
Using n2khabmon and got stuck? Browse the [documentation][website] to see if you can find a solution. Still stuck? Post your question as an [issue on GitHub][new_issue]. While we cannot offer user support, we'll try to do our best to address it, as questions often lead to better documentation or the discovery of bugs.

Want to ask a question in private? Contact the package maintainer by [email][email].

### Propose an idea 💡

Have an idea for a new n2khabmon feature? Take a look at the [documentation][website] and [issue list][issues] to see if it isn't included or suggested yet. If not, suggest your idea as an [issue on GitHub][new_issue]. While we can't promise to implement your idea, it helps to:
...
Using n2khabmon and discovered a bug? That's annoying! Don't let others have the same experience and report it as an [issue on GitHub][new_issue] so we can fix it. A good bug report makes it easier for us to do so, so please include:
...
Care to fix bugs or implement new functionality for n2khabmon? Awesome! 👏 Have a look at the [issue list][issues] and leave a comment on the things you want to work on. See also the development guidelines below.
...
├── DESCRIPTION
├── LICENSE
├── n2khabmon.Rproj     <- Main RStudio project file.
├── NAMESPACE
...
Recommended resources to get started are:
    ...
    Or use markdown support in function documentation.
